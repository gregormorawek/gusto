            ...
            {schritt <= ANZAHL_FRAGEN ? (
              ...
              >
                ...
                <div className="mt-6 flex min-h-0 flex-1 flex-col justify-center overflow-hidden">
                  ...
                  {schritt === 5 && (
                    ...
                    // touch-pan-y overflow-x-hidden overscroll-none:
                    // dieselbe Absicherung gegen WKWebViews interne
                    // WKChildScrollView-Bewegung wie am App.jsx-Content-
                    // Wrapper (siehe dortiger, ausfuehrlicher Kommentar zur
                    // Herleitung ueber ein natives Laufzeit-Log, inkl. der
                    // beiden NACHTRAEGE zu overscroll-none und
                    // overflow-x-hidden) - jeder eigene overflow-y-auto-
                    // Bereich in der App bekommt einzeln so eine eigene
                    // ScrollView, nicht nur der App.jsx-Wrapper. Hier ohne
                    // horizontal-transformierte Kinder (nur statische
                    // OptionZeile-Reihen) also nicht der eigentliche Bug-
                    // Fundort, aber aus Konsistenzgruenden identisch
                    // behandelt.
                    <div className="flex flex-col gap-2 touch-pan-y overflow-y-auto overflow-x-hidden overscroll-none py-2">
              ...
              >
                ...
                {/* Derselbe "py-2 als Schatten-Puffer"-Kniff wie bei den
                    ...
                    touch-pan-y/overflow-x-hidden/overscroll-none - siehe
                    Kommentar bei den OptionZeile-Containern oben. */}
                <div className="mt-4 flex min-h-0 flex-1 flex-col touch-pan-y justify-center gap-2 overflow-y-auto overflow-x-hidden overscroll-none py-2">
